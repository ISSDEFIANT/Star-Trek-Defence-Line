	...
	public class PlanetAsset : ScriptableObject
	{
		...
		public void OnEnable()
		{
			if( surfaceNoise == null )
			{
				...
				iceColour							= new Color( 1f, 1f, 1f, 1f );
				iceReach							= 0.308f;
				iceHeight							= 0.986f;
				...
				cloudNoise.scale					= 0.49f;
				cloudNoise.octaves					= 9;
				cloudNoise.falloff					= 9.13f;
				cloudNoise.intensity				= 16.16f;
				cloudNoise.ridginess				= 0.23f;
				cloudNoise.smearScale				= 19.76f;
				cloudNoise.smearOctaves				= 1;
				cloudNoise.smearFalloff				= 9.53f;
				cloudNoise.smearIntensity			= 15.73f;

				cloudColour0						= new Color( 1f, 1f, 1f, 1f );
				cloudColour1						= new Color( 0f, 0f, 0f, 0f );
				cloudSpin							= 1f;
				cloudNormalScale					= 0.02f;
