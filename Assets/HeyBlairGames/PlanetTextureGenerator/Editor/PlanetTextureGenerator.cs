...
namespace HeyBlairGames.PlanetTextureGenerator.Editor
{
	public class PlanetTextureGenerator
	{
...
#if true
			//cloud texture
			noiseGenerator.generateCloudNoise( previewWidth, previewHeight, _target.cloudNoise, _target.cloudColour0, _target.cloudColour1, _target.cloudSpin, _target.cloudNormalScale, false );
		...
		public void bakeCloudTextures()
		{
			...
			//create cloud data
			noiseGenerator.generateCloudNoise( width, height, _target.cloudNoise, _target.cloudColour0, _target.cloudColour1, _target.cloudSpin, _target.cloudNormalScale, false );
